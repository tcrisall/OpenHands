...
nerdctl build "$@" -t registry.home:5000/openhands-test:latest -f containers/app/Dockerfile .
...
nerdctl push --insecure-registry registry.home:5000/openhands-test:latest
